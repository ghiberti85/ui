...
const darkModeTokens = {
  ...
  // ds-icc — dark-first; dark mode = same as base (already dark)
  'ds-icc': {
    ...
    'color-semantic-primary':           '#22d3ee',
    'color-semantic-primary-foreground':'#020617',
    'color-semantic-primary-hover':     '#67e8f9',
    'color-state-success':              '#4ade80',
    'color-state-success-subtle':       '#052e16',
  ...
  // ds-dil — dark mode: deeper navy with brighter lime
  'ds-dil': {
    'color-semantic-background':        '#050c1a',
    'color-semantic-background-subtle': '#0a0f1e',
    'color-semantic-foreground':        '#e8edf7',
    'color-semantic-foreground-muted':  '#7a8fc4',
    'color-semantic-border':            '#253558',
    'color-semantic-primary':           '#a3e635',
    'color-semantic-primary-foreground':'#050c1a',
    'color-semantic-primary-hover':     '#bef264',
    'color-state-success':              '#4ade80',
    'color-state-success-subtle':       '#052e16',
    'color-state-success-foreground':   '#050c1a',
    'color-state-warning':              '#fbbf24',
    'color-state-warning-subtle':       '#1c1408',
    'color-state-warning-foreground':   '#050c1a',
    'color-state-error':                '#f87171',
    'color-state-error-subtle':         '#1f0505',
    'color-state-error-foreground':     '#e8edf7',
    'color-state-info':                 '#60a5fa',
    'color-state-info-subtle':          '#030d1f',
    'color-state-info-foreground':      '#050c1a',
  },
  // ds-financas — dark mode: warm stone dark palette
  'ds-financas': {
    'color-semantic-background':        '#1c1917',
    'color-semantic-background-subtle': '#292524',
    'color-semantic-foreground':        '#fafaf9',
    'color-semantic-foreground-muted':  '#a8a29e',
    'color-semantic-border':            '#44403c',
    'color-semantic-primary':           '#2dd4bf',
    'color-semantic-primary-foreground':'#1c1917',
    'color-semantic-primary-hover':     '#5eead4',
    'color-state-success':              '#4ade80',
    'color-state-success-subtle':       '#052e16',
    'color-state-success-foreground':   '#1c1917',
    'color-state-warning':              '#fbbf24',
    'color-state-warning-subtle':       '#1c1408',
    'color-state-warning-foreground':   '#1c1917',
    'color-state-error':                '#f87171',
    'color-state-error-subtle':         '#1f0505',
    'color-state-error-foreground':     '#fafaf9',
    'color-state-info':                 '#22d3ee',
    'color-state-info-subtle':          '#0c2a31',
    'color-state-info-foreground':      '#1c1917',
  },
}
